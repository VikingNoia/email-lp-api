...
MENSAGEM_DE_RESPOSTA = "📋 Agora preciso que você realize seu cadastro em nosso site \n 💼 Empresa: Supermercados Atacadão 🔰 Status: *Aguardando Cadastro.* _Para realizar seu cadastro, clique no link abaixo para acessar o site:_ 👉 https://linktr.ee/Realizar.Cadastro 👉 https://linktr.ee/Realizar.Cadastro _Após acessar o site digite *"OK"* para prosseguir._"
